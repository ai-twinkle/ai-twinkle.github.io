...
* **Measurable Security Boost**: Overall security scores increased by an average of **19.4%**, with specific attack scenarios showing up to a **33.9%** improvement.
* **Outperforming Global Models**: The F1 + XecGuard combination significantly outperformed international commercial models, including **Llama 3B**, **Gemma 4B**, and **DeepSeek 8B**, in security resilience.
* **Precision Defense**: Effectively counters threats like **Prompt Injection** and **Prompt Extraction** while maintaining high-quality responses for essential tasks.
